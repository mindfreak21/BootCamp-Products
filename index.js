...
function onSubmit(event)
{
    ...
    cantidadTotal = parseFloat(cantidad) + parseFloat(cantidadTotal);
    preciosTotales = parseFloat(precio) + parseFloat(preciosTotales);
    granTotal = parseFloat(total) + parseFloat(granTotal);
